...
//subject_id - priority: GET > POST > SESSION
...
if($action === 'delete' && isset($_GET['naloga_id'])) {
    ...
    if ($user_type == 'ucitelj') {
        ...
        die("Samo učitelji lahko brišejo naloge.");
        }
}
...
if ($user_type == 'ucenec') {
    //verify they are enrolled in this subject
        ...
        <ul class="subject-list">
            ...
            if (count($themes) > 0) {
                foreach($themes as $theme) {
                    ...
                    $theme_url = "?theme_id=" . $theme['Id_vsebine'] . "&subject_id=" . $subject_id;
                    echo "<a href='" . htmlspecialchars($theme_url) . "' class='download-btn'>";
